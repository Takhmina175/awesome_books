...
const luxon = (function (exports) {
  ...
  const ConflictingSpecificationError = /* #__PURE__ */ (function (
    _LuxonError4
  ) {
  ...
  function signedOffset(offHourStr, offMinuteStr) {
    ...
    const offMinSigned =
      offHour < 0 || Object.is(offHour, -0) ? -offMin : offMin;
  ...
  const Formatter = /* #__PURE__ */ (function () {
    ...
    _proto.formatDurationFromString = function formatDurationFromString(
      ...
      const collapsed = dur.shiftTo.apply(
        dur,
    ...
    _proto4.months = function months$1(length, format, defaultOK) {
      ...
      return listStuff(this, length, defaultOK, months, () => {
        ...
        if (!_this.monthsCache[formatStr][length]) {
          _this.monthsCache[formatStr][length] = mapMonths((dt) =>
            _this.extract(dt, intl, "month")
          );
        }
    ...
    _proto4.weekdays = function weekdays$1(length, format, defaultOK) {
      ...
      return listStuff(this, length, defaultOK, weekdays, () => {
        ...
        if (!_this2.weekdaysCache[formatStr][length]) {
          _this2.weekdaysCache[formatStr][length] = mapWeekdays((dt) =>
            _this2.extract(dt, intl, "weekday")
          );
        }
      ...
      return listStuff(
        ...
        () => {
          ...
          if (!_this3.meridiemCache) {
            ...
            ].map((dt) => _this3.extract(dt, intl, "dayperiod"));
          }
    ...
    _proto4.eras = function eras$1(length, defaultOK) {
      ...
      return listStuff(this, length, defaultOK, eras, () => {
        ...
        if (!_this4.eraCache[length]) {
          ...
          ].map((dt) => _this4.extract(dt, intl, "era"));
        }
  ...
  const isoTimeBaseRegex =
    /(\d\d)(?::?(\d\d)(?::?(\d\d)(?:[.,](\d{1,30}))?)?)?/;
  const isoTimeRegex = RegExp(
  ...
  var Duration = /* #__PURE__ */ (function () {
    ...
    _proto.mapUnits = function mapUnits(fn) {
      ...
      for (
        let _i = 0, _Object$keys = Object.keys(this.values);
    ...
    _proto.negate = function negate() {
      ...
      for (
        let _i2 = 0, _Object$keys2 = Object.keys(this.values);
  ...
  var Interval = /* #__PURE__ */ (function () {
    ...
    Interval.merge = function merge(intervals) {
      const _intervals$sort$reduc = intervals
        .sort((a, b) => a.s - b.s)
        .reduce(
          (_ref2, item) => {
            const sofar = _ref2[0];
    ...
    Interval.xor = function xor(intervals) {
      ...
      const flattened = (_Array$prototype = Array.prototype).concat.apply(
        _Array$prototype,
        ends
      );
  ...
  function hasInvalidGregorianData(obj) {
    ...
    const validDay = integerBetween(
      obj.day,
      1,
      daysInMonth(obj.year, obj.month)
    );
  ...
  function toTechTimeFormat(dt, _ref) {
    ...
    const suppressSeconds =
      _ref$suppressSeconds === void 0 ? false : _ref$suppressSeconds;
    const _ref$suppressMillisec = _ref.suppressMilliseconds;
    const suppressMilliseconds =
      _ref$suppressMillisec === void 0 ? false : _ref$suppressMillisec;
    const { includeOffset } = _ref;
    const _ref$includePrefix = _ref.includePrefix;
    const includePrefix =
      _ref$includePrefix === void 0 ? false : _ref$includePrefix;
  ...
  function quickDT(obj, opts) {
    ...
    let ts;
    let o; // assume we have the higher-order units
  ...
  var DateTime = /* #__PURE__ */ (function () {
    ...
    _proto.resolvedLocaleOptions = function resolvedLocaleOptions(opts) {
      ...
      const _Formatter$create$res = Formatter.create(
        this.loc.clone(opts),
        opts
    ...
    _proto.setZone = function setZone(zone, _temp) {
      ...
      const keepLocalTime =
        _ref3$keepLocalTime === void 0 ? false : _ref3$keepLocalTime;
      const _ref3$keepCalendarTim = _ref3.keepCalendarTime;
      const keepCalendarTime =
        _ref3$keepCalendarTim === void 0 ? false : _ref3$keepCalendarTim;
    ...
    */
    ...
    _proto.toSQLTime = function toSQLTime(_temp5) {
      ...
      const includeZone =
        _ref7$includeZone === void 0 ? false : _ref7$includeZone;
    ...
    _proto.hasSame = function hasSame(otherDateTime, unit) {
      ...
      return (
        otherZoneDateTime.startOf(unit) <= inputMs &&
        inputMs <= otherZoneDateTime.endOf(unit)
      );
    };
    /**
     * Equality check
